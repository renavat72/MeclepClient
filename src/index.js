...
const API_URL = 'http://augmented-path-304210.ey.r.appspot.com/graphql'||'http://localhost:8081/graphql'||'http://localhost:5000/graphql'
const WEBSOCKET_API_URL ='ws://augmented-path-304210.ey.r.appspot.com/graphql'||'ws://localhost:8081/graphql'||'ws://localhost:5000/graphql'
