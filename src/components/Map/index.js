...
const TypeMarker = (post) => {
  if (post.typeOfEvent === 'Party') {
    return Party;
  }
  if (post.typeOfEvent === 'Meeting') {
    return Meeting;
  }
  if (post.typeOfEvent === 'Exhibition') {
    return Exhibition;
  }
  if (post.typeOfEvent === 'Club') {
    return Club;
    ...
    <div>
      ...
      >
        ...
        {selected ? (
          ...
          >
            {selected.urlContent ? (
              <AnotherEventWindow post={selected} />
            ) : (
